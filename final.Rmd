...
Next, the function runs a while loop until no node is in the infected state. For each loop, time *t* increased by 1. Then, the infected nodes are saved into a variable and sequentially given a chance to recover if thire assigned random probability is lower than mu. This concludes the simulation of recovery.
