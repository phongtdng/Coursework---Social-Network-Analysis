...
distinct(vaccination_targeted_closeness, inf)
distinct(vaccination_targeted_between, inf)
distinct(vaccination_targeted_pagerank, inf)
```

No matter the centrality use to determine vaccinated nodes, the information spread to all 215 remaining nodes as the number of rows for each table shows.
